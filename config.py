...
exp_name = f"{model_arch_name}-Form_classifier"

if mode == "train":
    # Dataset address
    train_image_dir = "/ssd_scratch/cvit/shaon/form_classification/train"
    valid_image_dir = "/ssd_scratch/cvit/shaon/form_classification/val"
...
if mode == "test":
    # Test data address
    test_image_dir = "/ssd_scratch/cvit/shaon/form_classification/train"
    ...
    model_weights_path = "/ssd_scratch/cvit/shaon/results/resnet50-Form_classifier/last.pth.tar"
